...
QT_MOC_LITERAL(8, 97, 15), // "addScalableItem"
QT_MOC_LITERAL(9, 113, 14), // "AGraphicsItem*"
QT_MOC_LITERAL(10, 128, 8), // "gateType"
QT_MOC_LITERAL(11, 137, 15), // "scaleUpSelected"
QT_MOC_LITERAL(12, 153, 17) // "scaleDownSelected"

    },
    "gui::CustomGraphicsScene\0itemsSelected\0"
    "\0QVector<qint64>\0itemIds\0itemsConnected\0"
    "sourceId\0targetId\0addScalableItem\0"
...
void gui::CustomGraphicsScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { AGraphicsItem* _r = _t->addScalableItem((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< AGraphicsItem**>(_a[0]) = std::move(_r); }  break;
        case 3: _t->scaleUpSelected(); break;
        case 4: _t->scaleDownSelected(); break;
        default: ;
        }
    } else if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
        switch (_id) {
